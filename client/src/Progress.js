    ...
    return (
      ...
      <div className="content">
        ...
        <div className="row">
          ...
          <label htmlFor="name" className="input-label"><strong>Goal:</strong></label>
          <div type="text" id="name" name="goal_name" className="input-label" >Kid's College</div>
            ...
            <div className="mobile-column" >
            <label htmlFor="target" className="input-label" ><strong>Amount:</strong></label>
            ...
            <div className="mobile-column" >
            <label htmlFor="current" className="input-label" ><strong>Balance:</strong></label>
            ...
            <div className="mobile-column" >
            <label htmlFor="date" className="input-label"><strong>Date:</strong></label>
      ...
      <div className="progress-fill">
        <span>82%</span>
          ...
          <div className="buttons">
            ...
            <div classID="submit" className="button-label">
